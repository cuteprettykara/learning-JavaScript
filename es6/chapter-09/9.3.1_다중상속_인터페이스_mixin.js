...
// 믹스인이란 '기능을 필요한 만큼 섞어 놓은 것' 입니다.
// 자바스크립트는 느슨한 타입을 사용하고, 대단히 관대한 언어이므로,
...
makeInsurable(car1);                            // car1이 보험가입 기능을 갖도록 합니다.
car1.addInsurancyPolicy(new InsurancePolicy()); // works
console.log(car1.isInusred());


const car2 = new Car("Mazda", "3i");
makeInsurable(car2);                            // car2가 보험가입 기능을 갖도록 합니다. 어? 모든 자동차에 이 짓을 해야 하나요?
