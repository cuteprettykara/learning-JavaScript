...
// car1 객체에는 shift 메소드가 없지만, car1.shift('D')를 호출하면 
// 자바스크립트는 car1의 프로토타입에서 같은 이름의 메소드를 검색합니다.

// car1에 shift 메소드를 추가하면, car1과 프로토타입에 같은 이름의 메소드가 존재하게 됩니다.
// 이제 car1.shift('D')를 호출하면, car1의 메소드가 호출되고, 프로토타입의 메소드는 호출되지 않습니다.