...
// 정규식 리터럴을 쓰면 타이핑하는 수고도 덜 수 있고, 자바스크립트 문자열에서 으레 하는 
// 역슬래시를 사용한 이스케이프도 줄어듭니다.
...
console.log(result);    // [ "@arthur", "@nick", "@yvette" ]

// 이 예제에서 사용한 정규식을 리터럴로 만든다면  /@(?:mary|nick|arthur|sam|yvette)\b/g 일겁니다.
// 하지만 여기서는 동적으로 정규식을 만들었습니다.
// 단어 경계 메타 문자인 b 앞에 역슬래시 두 개를 썼습니다.
// 역슬래시 두 개를 쓰지 않았다면 정규식 엔진은 \b를 리터럴 문자 b로 판단합니다.
